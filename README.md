...
My work sits where geospatial analysis meets software. I automate data cleaning with Python, wrangle messy GIS data into clean schemas, and put the results on the web. I care about data that are accurate, readable, and useful.
